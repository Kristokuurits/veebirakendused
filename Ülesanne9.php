...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $nimi = $_POST["nimi"];
        $tervitus = ucfirst(strtolower($nimi));
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ropud_sonad = ["roppsõna1", "roppsõna2", "roppsõna3"];
    ...
    <h2> Teksti tükeldamine punktide lisamiseks</h2>
    <form method="post">
    ...
    <h2> Ropud sõnad tärnidega asendamine</h2>
    <form method="post">
    ...
    <h2> Emaili loomine eesnime ja perenime põhjal</h2>
    <form method="post">
